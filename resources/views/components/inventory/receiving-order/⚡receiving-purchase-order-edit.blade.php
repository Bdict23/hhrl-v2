    ...
    <div class="grid gap-4 mb-10">
        ...
        <x-ts-card>
            <div class="grid grid-cols-4 w-full">
                ...
                <div class="grid gap-3 p-2">
                    <x-ts-input label="Receiving No̱." wire:model.blur="receivingNumber"/>
                    <x-ts-input label="Delivery Receipt No̱." wire:model.blur="deliveryReceiptNumber"/>
                </div>
                <div class="grid gap-3 p-2">
                    <x-ts-input label="Delivered By" wire:model.blur="deliveredBy"/>
                    <x-ts-input label="Invoice No̱." wire:model.blur="invoiceNumber"/>
                </div>
            </div>
        </x-ts-card>
