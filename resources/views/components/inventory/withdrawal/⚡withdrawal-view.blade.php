...
use App\Services\Inventory\WithdrawalService;
...
new class extends Component
{
    ...
    {
        return redirect()->route('withdrawal.edit', ['id' => $this->withdrawalId]);
    }
...
<div>
    <div class="flex justify-between">
        <x-ts-breadcrumbs separator="icon:chevron-right" :items="[
          ...
          <label class="text-2xl italic mb-2">( {{ $reference }} )</label>
    </div>
            ...
            <div class="grid grid-cols-2">
                <div class="grid gap-2 p-3">
                    ...
                    <x-ts-stats number="{{ number_format($grand_total, 2) }}" title="Total Cost">
                            ...
                            <x-slot:right>
                                    <x-ts-button icon="arrow-left" flat class="underline" wire:click="backToSummary">Back</x-ts-button>
                                    @if( $step == 1)
                                        <x-ts-button icon="pencil" flat class="underline" wire:click="editWithdrawal">Edit</x-ts-button>
                                    @else
                                        <x-ts-button icon="pencil" flat class="underline" disabled>Edit</x-ts-button>
                                    @endif
                            </x-slot:right>
                    </x-ts-stats>
                </div>
