...
new class extends Component
{
    ...
    public function saveAsDraftAction(): void
    {
        ...
        $this->dialog()
        ->question('New Withdrawal', 'Are you sure to save this order as draft ?')
        ->confirm(
            'Confirm',
    ...
    public function saveAsFinalAction(): void
    {
        ...
        // 2. show confirmation dialog
         $this->dialog()
        ->question('New Withdrawal', 'Are you sure to save this order as final?')
        ->confirm(
            'Confirm',
            'store', //pass a functio to call
            )
    ...
    public function store(WithdrawalService $service)
    {
        try {
            ...
            // 4. Call the Service
            $po = $service->createWithdrawal($data);
...
<div>
    <div class="flex justify-between">
        <x-ts-breadcrumbs separator="icon:chevron-right" :items="[
                              ...
                              ['label' => 'Create withdrawal', 'icon' => 'pencil-square'],
                  ]"  class="mb-3"/>
    </div>
