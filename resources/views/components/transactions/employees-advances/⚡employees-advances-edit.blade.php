...
new class extends Component
{
    ...
    public function saveAsDraftAction(){
        $validated = $this->validate();
         $this->status = 'DRAFT';
         $this->dialog()
        ->question('Update employee cash advance', 'Are you sure to udpate this cash advance as draft?')
        ->confirm(
            'Confirm',
    ...
    public function saveAsFinalAction(){
        ...
        $this->dialog()
        ->question('Update employee cash advance', 'Are you sure to update this cash advance as final ?')
        ->confirm(
            'Confirm',
            'update', //pass a functio to call
            )
    ...
    public function update(EmployeesAdvanceService $employeesAdvanceService)
    {
        try {
            ...
            // 4. Call the Service
            $afe = $employeesAdvanceService->update($data);
