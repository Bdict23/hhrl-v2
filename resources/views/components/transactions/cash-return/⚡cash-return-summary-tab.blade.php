...
new class extends Component {
    ...
    {
        return [
            'pcvCrsHeader' => [['index' => 'status', 'label' => 'Status', 'sortable' => false], ['index' => 'reference', 'label' => 'Reference'], ['index' => 'pcv_id', 'label' => 'PCV-REF', 'sortable' => false], ['index' => 'prepared_by', 'label' => 'Prepared By', 'sortable' => false], ['index' => 'amount_returned', 'label' => 'Return Amount', 'sortable' => false], ['index' => 'created_at', 'label' => 'Returned Date'], ['index' => 'action', 'label' => 'Action', 'sortable' => false]],
            'aflCrsHeader' => [['index' => 'status', 'label' => 'Status', 'sortable' => false], ['index' => 'reference', 'label' => 'Reference'], ['index' => 'advances_liquidation_id', 'label' => 'AFL-REF', 'sortable' => false], ['index' => 'prepared_by', 'label' => 'Prepared By', 'sortable' => false], ['index' => 'amount_returned', 'label' => 'Return Amount', 'sortable' => false], ['index' => 'created_at', 'label' => 'Returned Date'], ['index' => 'action', 'label' => 'Action', 'sortable' => false]],
            'eventCrsHeader' => [['index' => 'status', 'label' => 'Status', 'sortable' => false], ['index' => 'reference', 'label' => 'Reference'], ['index' => 'event_id', 'label' => 'Event-REF', 'sortable' => false], ['index' => 'prepared_by', 'label' => 'Prepared By', 'sortable' => false], ['index' => 'amount_returned', 'label' => 'Return Amount', 'sortable' => false], ['index' => 'created_at', 'label' => 'Returned Date'], ['index' => 'action', 'label' => 'Action', 'sortable' => false]],
...
<div>
    <x-ts-tab wire:model.live="tab">
        ...
        <x-ts-tab.items tab="CRS (ADVANCES)">
            <div class="flex justify-end gap-4 mb-4">
                <x-ts-select.native wire:model.live="status" placeholder="All Statuses" :options="[
                    ['name' => 'All', 'id' => null],
                    ['name' => 'DRAFT', 'id' => 'DRAFT'],
