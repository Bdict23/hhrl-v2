...
<div>
    ...
    <x-ts-tab selected="Active Events">
        ...
        <x-ts-tab.items tab="Active Events">
            <div class="grid grid-cols-4 gap-4">
                @foreach ($activeEvents as $event)
                    <x-ts-card :header="$event->event_name" color="primary" light icon="calendar" minimize>
                        No details to display yet
                    </x-ts-card>
                @endforeach
            </div>
        </x-ts-tab.items>
